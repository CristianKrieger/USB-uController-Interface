...
public class SysUsbDevice implements Parcelable {
	private String VID;
	private String PID;
	...
	public static final Parcelable.Creator<SysUsbDevice> CREATOR = new Parcelable.Creator<SysUsbDevice>() {
		public SysUsbDevice createFromParcel(Parcel in) {
			return new SysUsbDevice(in);
		}

		public SysUsbDevice[] newArray(int size) {
			return new SysUsbDevice[size];
		}
	};
	
	public SysUsbDevice(){}
	
	public SysUsbDevice(Parcel in) {
		VID = in.readString();
		PID = in.readString();
